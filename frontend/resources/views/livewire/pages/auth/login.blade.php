<div class="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5">
    <div class="md-1/2 px-16 ">
        <h2 class="font-bold text-2xl text-[#002D74]">Giris Yap</h2>
        <p class="text-small mt-4 text-[#002D74]">
            Eğer üye iseniz kolaylıkla giris yapabilirsiniz.
        </p>
  ...
  <path d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5M4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0"/>
            ...
            <button class="bg-[#002D74] rounded-xl text-white py-2 hover:scale-105 duration-300 ">Giris</button>
        </form>
        <p class="mt-3 text-xs  border-gray-400  py-4" >Şifrenizi mi Unuttunuz ?</p>
        <div class="text-sm flex justify-between items-center">
            <p>Eğer hesabınız yoksa</p>
            <button class="py-2 px-5 bg-white border rounded-xl hover:scale-105 duration-300">Kayıt Ol</button>
        </div>
    </div>
    <div class="md:block hidden w-1/2">
        <img class=" rounded-2xl w-full h-full object-cover " src="{{ asset('images/login.jpg') }}"
        alt="">
    </div>
</div>